                            ...
                            <div class="text-md-end mt-3">
                                ...
                                <div class="dropdown d-inline">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton5">
                                        <a class="dropdown-item" href="{{ route('applicantsExport', ['type' => 'allPaid']) }}">Export All Data</a>
        ...
        $(document).ready(function() {
            ...
            var table = $('#applicants_table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'crm_notes_created_at', name: 'crm_notes.created_at' },
                    ...
                    { data: 'customStatus', name: 'crm_notes.moved_tab_to' },
